        ...
        <section className="flex items-center justify-center mt-12 p-4">
            <form onSubmit={(e) => onsubmit(e)} className="flex flex-col gap-3 p-8 shadow-lg rounded-xl max-w-162 w-full">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link to={"/"} type="submit" className="grow-0 mt-2 py-2 px-6 bg-red-800 text-white font-medium rounded-lg cursor-pointer transition-all duration-300 hover:bg-red-900">
                        Cancelar
                    </Link>
                </div>
            </form>
